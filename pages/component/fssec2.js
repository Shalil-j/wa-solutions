...
function Sec2() {
  ...
  let card2
  if(cards){
card1=<div className='mx-auto space-y-5 h-auto md:space-y-0 w-80 md:w-auto md:grid md:grid-col-3 md:grid-flow-col md:gap-5 pb-10 md:pl-14 md:pr-14 lg:pl-24 lg:pr-24 pt-10'>
...
<div className='mt-5'>
<p className='text-xs lg:text-sm flex text-left pl-5 p-2 mt-5 space-x-5'><AiOutlineCheck /> Paid Monthly for 12 Months</p>
<p className='text-xs  lg:text-sm flex text-left pl-5 mt-5 space-x-5'> <AiOutlineCheck/>Pay after you get placed</p>
<p className='text-xs  lg:text-sm flex text-left pl-5 mt-5 space-x-5 '><AiOutlineCheck/>Total Amount Payable - ₹1,20,000 + GST</p>
</div>
</div>
...
<p className='text-xs lg:text-sm  flex text-left pl-5 p-2 mt-5 space-x-5'><AiOutlineCheck/> Paid Monthly for 12 Months</p>
<p className='text-xs lg:text-sm  flex text-left pl-5 mt-5 space-x-5'> <AiOutlineCheck/>Pay after you get placed</p>
<p className='text-xs lg:text-sm  flex text-left pl-5 mt-5 space-x-5 '><AiOutlineCheck/>Total Amount Payable - ₹1,80,000 + GST</p>
</div>
</div>
...
<p className='text-xs lg:text-sm flex text-left pl-5 p-2 mt-5 space-x-5'><AiOutlineCheck/> Paid Monthly for 12 Months</p>
<p className='text-xs lg:text-sm  flex text-left pl-5 mt-5 space-x-5'> <AiOutlineCheck/>Pay after you get placed</p>
<p className='text-xs lg:text-sm  flex text-left pl-5 mt-5 space-x-5 '><AiOutlineCheck/>Total Amount Payable - ₹2,40,000 + GST</p>
</div>
</div>
</div>
  }
  ...
  <div className='mt-5'>
  <p className='text-xs lg:text-sm flex text-left pl-5 p-2 mt-5 space-x-5'><AiOutlineCheck/> 0 Cost EMI options available</p>
  <p className='text-xs lg:text-sm flex text-left pl-5 mt-5 space-x-5'> <AiOutlineCheck/>No Additional Payment after placement</p>
  <p className='text-xs lg:text-sm flex text-left pl-5 mt-5 space-x-5 '><AiOutlineCheck/>GST Extra Applicable</p>
  </div>
  </div>
  </div>
  ...
  <div className="inline-flex focus:shadow-lg" role="group">
    <button onClick={()=>setCard(true)} type="button" className="rounded-l inline-block px-6 py-2.5 bg-indigo-600 text-white font-medium text-xs leading-tight uppercase hover:bg-white hover:text-indigo-700 focus:bg-blue-700 focus:outline-none focus:ring-0 active:bg-white transition duration-150 ease-in-out">Pay After Placement</button>
    <button onClick={()=>setCard(false)} type="button" className=" rounded-r inline-block px-6 py-2.5 bg-indigo-600 text-white font-medium text-xs leading-tight uppercase hover:bg-white focus:bg-blue-700 focus:outline-none hover:text-indigo-700 focus:ring-0 active:bg-white transition duration-150 ease-in-out">Pay Upfront</button>
  </div>
</div>
{/* card */}
<div>
  {cards? card1 : card2}
    ...
    <div className='lg:flex p-10 justify-between'>
